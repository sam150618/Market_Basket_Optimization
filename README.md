# Market Basket Optimization System
...
This model can be implemented as a recommender system by an e-commeerce company, as well as used to determine which products can be sold in form of combos (in order to improve the net sales return).
